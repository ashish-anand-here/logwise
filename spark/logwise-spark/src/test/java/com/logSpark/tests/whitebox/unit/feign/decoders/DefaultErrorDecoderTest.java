package com.logSpark.tests.whitebox.unit.feign.decoders;

import com.logSpark.constants.Groups;
import com.logSpark.dataproviders.DefaultErrorDecoderTestDataProvider;
import com.logSpark.feign.decoders.DefaultErrorDecoder;
import com.logSpark.feign.exceptions.ClientErrorException;
import com.logSpark.feign.exceptions.FeignClientException;
import com.logSpark.feign.exceptions.ServerErrorException;
