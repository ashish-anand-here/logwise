package com.logSpark.stream.impl;

import static org.apache.spark.sql.functions.*;

import com.google.inject.Inject;
import com.logSpark.constants.Constants;
import com.logSpark.protobuf.VectorLogs;
import com.logSpark.schema.Schema;
import com.logSpark.services.KafkaManagerService;
import com.logSpark.services.KafkaService;
import com.logSpark.services.SparkMasterService;
import com.logSpark.services.SparkStageHistoryService;
import com.logSpark.utils.ApplicationUtils;
import com.logSpark.utils.ConfigUtils;
                ...
                (MapFunction<Row, Row>)
                    row -> {
                      ...
                      return RowFactory.create(
                          ...
                          ApplicationUtils.convertMapToJsonString(vectorLogs.getDdtagsMap()),
                          ApplicationUtils.convertProtoTimestampToIso(vectorLogs.getTimestamp()),
                          vectorLogs.getEnv(),
                          vectorLogs.getServiceName(),
                          vectorLogs.getComponentName(),
                          vectorLogs.getHostname(),
                          vectorLogs.getDdsource(),
                          vectorLogs.getSourceType(),
                          vectorLogs.getStatus());
                    },
                rowEncoder)
            .withColumn(
